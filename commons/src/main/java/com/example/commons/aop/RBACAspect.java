...
import com.example.commons.aop.annotations.HasRole;
import com.example.commons.config.PublicEndpointConfig;
import com.example.commons.config.UserContext;
import com.example.commons.exception.AccessDeniedException;
...
public class RBACAspect {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RBACAspect.class.getName());
    ...
    @Before("@annotation(com.example.commons.aop.annotations.IsAdmin)")
    ...
    @Before("@annotation(com.example.commons.aop.annotations.IsVendor)")
    ...
    @Before("@annotation(com.example.commons.aop.annotations.IsUser)")
